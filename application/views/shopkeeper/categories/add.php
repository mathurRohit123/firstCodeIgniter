...
<div class="container">
    <h2 class="mt-4">Add New Category of Products</h2>
    <hr>
    <form action="<?= base_url('shopkeeper/categories/add'); ?>" method="post">

        <div class="mb-3">
            <label class="form-label">Give category name</label>
