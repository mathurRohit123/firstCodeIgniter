...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mt-4">
        ...
        <a href="<?= base_url('worker/products/add'); ?>" class="btn btn-success">Add New Product</a>
    </div>
        ...
        <tbody>
            <?php if (!empty($products)): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('worker/products/edit/' . $product['p_id']); ?>" class="btn btn-sm btn-warning">Edit</a>
                        
                        <form action="<?= base_url('worker/products/delete/' . $product['p_id']); ?>" method="post" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this product?');">
