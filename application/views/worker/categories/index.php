...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mt-4">
        ...
        <!-- <a href="<?= base_url('worker/categories/add'); ?>" class="btn btn-success">Add New Category</a> -->
    </div>
        ...
        <tbody>
            <?php if (!empty($categories)): ?>
                ...
                <tr>
                    ...
                    <!-- <td>
                        <a href="<?= base_url('worker/categories/edit/' . $category['c_id']); ?>" class="btn btn-sm btn-warning">Edit</a>

                        <form action="<?= base_url('worker/categories/delete/' . $category['c_id']); ?>" method="post" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this category?');">
